...
namespace StylizedWaterShader
{
    ...
    public class StylizedWaterInspector : Editor
    {
        ...
        void DoHeader()
        {
            ...
            EditorGUILayout.HelpBox("Unity 6 is far outside of the supported and compatible scope for this asset", MessageType.Error);
            
            GUILayout.Space(8);
            using (new EditorGUILayout.HorizontalScope())
            {
                GUILayout.FlexibleSpace();
                if (GUILayout.Button("See Stylized Water 3", GUILayout.Width(220)))
                {
                    Application.OpenURL("https://assetstore.unity.com/packages/slug/287769?aid=1011l7Uk8&pubref=sw1editor");
                }
                GUILayout.Space(8);
            }
            GUILayout.Space(11);
            ...
            {
                EditorGUILayout.HelpBox("The Universal Render Pipeline is in use,\nwhich this asset does not support.\n\nSee the Stylized Water 2 asset...", MessageType.Error);
                ...
                using (new EditorGUILayout.HorizontalScope())
                {
                    ...
                    {
                        Application.OpenURL("https://assetstore.unity.com/packages/vfx/shaders/170386?aid=1011l7Uk8&pubref=sw1editor");
                    }
                    GUILayout.Space(8);
                }
                GUILayout.Space(11);
        ...
        void DoLighting()
        {
            ...
            if (EditorGUILayout.BeginFadeGroup(lightingSection.anim.faded))
            {
                ...
                EditorGUILayout.PropertyField(lightingMethod);
